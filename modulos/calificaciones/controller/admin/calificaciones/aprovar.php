...
$titulo_columnas_grid = array("createdAt" => "Fecha",$campo_item => "Item", "nombre" =>  "Nombre","titulo" => "Titulo","calificacion" => "Calificacion");
$value_columnas_grid = array("createdAt" ,$campo_item, "nombre","titulo","calificacion");
$css_columnas_grid = array("createdAt" => "w-xxxx-1" ,$campo_item => "w-xxxx-3" ,"nombre" => "w-xxxx-2", "titulo" => "w-xxxx-3", "calificacion" => "w-xxxx-1");
