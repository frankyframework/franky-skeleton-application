...
$this->comentario = (isset($data["comentario"]) ? $data["comentario"] : null);
    ...
    {
        return array( "id" => array("valor" => $this->id,"required"),"id_item" => array("valor" => $this->id_item,"required"),"tabla" => array("valor" => $this->tabla,"required"),"createdAt" => array("valor" => $this->createdAt,"required"),"updateAt" => array("valor" => $this->updateAt,"required"),"status" => array("valor" => $this->status,"required"),"aprovado" => array("valor" => $this->aprovado,"required"),"calificacion" => array("valor" => $this->calificacion,"required"),"titulo" => array("valor" => $this->titulo,"required"),"comentario" => array("valor" => $this->comentario,"required"),);
    }
