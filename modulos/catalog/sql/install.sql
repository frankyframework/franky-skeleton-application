...
insert into `franky` ( `php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('admin/wishlist/lista.php','','','[]','[1,2]','ADMIN_WISHLIST','admin/wishlist/','Lista de deseos','[\"base/ajax.admin.js\"]','1','0','catalog');
