...
insert into `franky` ( `php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('admin/wishlist/lista.php','','','','[1,2]','ADMIN_CATALOG_WISHLIST','admin/catalog-wishlist/','Administras whishlist','[\"base/ajax.admin.js\"]','1','1','catalog');
...
insert into `franky` ( `php`, `css`, `js`, `jquery`, `permisos`, `constante`, `url`, `nombre`, `ajax`, `status`, `editable`, `modulo`) values('admin/catalog_vitrinas/form.php','','','[\"jquery-validate\"]','[1,2]','FRM_CATALOG_VITRINA','admin/catalog-vitrinas/form/','Alta y edicion de vitrinas','[\"base/ajax.admin.js\",\"catalog/ajax.admin.js\"]','1','0','catalog');
