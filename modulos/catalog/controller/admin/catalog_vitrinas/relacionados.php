...
$MyFrankyMonster->setLayout(PROJECT_DIR.'/modulos/catalog/diseno/admin/layout/empty_index.phtml');
...
$title_grid = "Productos de la vitrina";
$class_grid = "products_vitrina";
