            ...
            beforeSend: function(){
              if(area_loader != null)
              {
                  ...
                  if(area_loader == 'body')
                  {
                       ...
                       <div style="width: 100px;height: 100px;position: absolute;left:50%; top:50%;background: url(\'/public/skin/default/images/loader.gif\') no-repeat center 0; margin:-50px 0 0 -50px;">&nbsp;</div>\
                    </div>');
                  ...
                  {
                       var loader = $('<div id="preloaderfullpage'+rand_id+'" style="width: 100px;height: 100px;position: absolute;left:50%; top:50%;background: url(\'/public/skin/default/images/loader.gif\') no-repeat center 0; margin:-50px 0 0 -50px;">&nbsp;</div>');
